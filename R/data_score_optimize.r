...
# NOTE: linear regression did not result in sensible weights, likely due to having very few knownpositives for linearregression to be applicable.
data_score_optimize_linearregression=function(d, knownpositives, o=list()){
  #d=fusion_pos_cal$data
  #d$score=NULL
  #knownpositives=unlist(strsplit(fusion_pos_cal$knownpositives, ", "))
