...
for(i in 1:length(ps.as)){
  res_list[[i]]=ps.as[[i]]$datawithscore
}

disease=unlist(lists_extractfield(ps.as, 'disease'))

names(res_list)=disease

openxlsx::write.xlsx(res_list, "../doc/IMMUNOTAR_SHRAIM_20230111.manuscript/Supplemental files/Supplemental_tables_results.xlsx", rowNames=T)
